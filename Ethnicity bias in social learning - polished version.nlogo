...
to learn
  ...
  if learning-strategy = 0 [
    ...
    if random-float 1 < (training-data - payoff) [
  ...
  if learning-strategy = 1 [
    ...
    ; checking if your partner is nobody prevent
...
to shoot-success
  ...
  vid:save-recording "ethncity-bias-success"
  vid:reset-recorder
...
to shoot-failure
  ...
  vid:save-recording "ethncity-bias-failure"
  vid:reset-recorder
...
"" ""
PENS
"default" 1.0 0 -13791810 true "" "plot count turtles with [strategy = 0] / num-turtles"
"pen-1" 1.0 0 -2139308 true "" "plot count turtles with [strategy = 1] / num-turtles"
...
@#$#@#$#@
<experiments>
  <experiment name="pilot" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <exitCondition>success? or collapse?</exitCondition>
    <metric>success?</metric>
    <metric>collapse?</metric>
    <enumeratedValueSet variable="mr_marker">
      <value value="0"/>
    </enumeratedValueSet>
    <steppedValueSet variable="random-pairing" first="0.1" step="0.1" last="1"/>
    <steppedValueSet variable="game" first="1" step="1" last="10"/>
    <enumeratedValueSet variable="mr_learning_style">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ethnic_bias?">
      <value value="true"/>
    </enumeratedValueSet>
  ...
  <experiment name="basic-parameters-2" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5000"/>
    <exitCondition>success? or collapse?</exitCondition>
    ...
    <steppedValueSet variable="random-pairing" first="0.1" step="0.1" last="1"/>
    <steppedValueSet variable="game" first="1" step="1" last="4"/>
    <enumeratedValueSet variable="mr_learning_style">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ethnic_bias?">
  ...
  <experiment name="sensitivity to initial level of ethnic learning" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="time-series" repetitions="500" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="800"/>
    <metric>count turtles with [learning-style = 1] / num-turtles</metric>
    <enumeratedValueSet variable="mr_marker">
      <value value="0"/>
    </enumeratedValueSet>
  ...
  <experiment name="sensitivity to initial level of ethnic learning-mem 5" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="4000"/>
    <exitCondition>success? or collapse?</exitCondition>
    ...
    <enumeratedValueSet variable="memory_size">
      <value value="5"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
